			...
			<div class="adresymodal-window">
				...
				<div id="div3">
					...
					<form id="dodajStudentow" action="../connects/upload_file_db.php" enctype="multipart/form-data" method='post'>
						...
						if (isset($_SESSION['nazwisko_nie_numeryczne'])) //sprawdza czy zmienna błąd jest ustawiona w sesji
						{
							echo $_SESSION['nazwisko_nie_numeryczne'];
						}
						if (isset($_SESSION['imie_nie_numeryczne'])) //sprawdza czy zmienna błąd jest ustawiona w sesji
						{
							echo $_SESSION['imie_nie_numeryczne'];
						}
						if (isset($_SESSION['telefon_numeryczny'])) //sprawdza czy zmienna błąd jest ustawiona w sesji
						{
							echo $_SESSION['telefon_numeryczny'];
						}
						?>
					</form>
				</div>
			...
			<div class="form-container">
				<div class="w-form">
					...
					<form action="sms.php" id="email-form" name="email-form" data-name="Email Form" class="form-flex" method="post">
						...
						<textarea id="wiadomosc" placeholder="Podaj tresc wiadomosci bez polskich znakow..." name="wiadomosc" data-name="wiadomosc" class="w-input input textarea" onkeyup="countChar(this)" maxlength="130"></textarea>
