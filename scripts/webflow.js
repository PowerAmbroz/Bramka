...
Webflow.require('ix').init([
  {"slug":"open-adresy","name":"Open Adresy","value":{"style":{},"triggers":[{"type":"click","selector":".adresymodal-bg","stepsA":[{"opacity":0},{"display":"flex"},{"opacity":1,"transition":"opacity 500ms ease 0ms"}],"stepsB":[]}]}},
  {"slug":"close-adresy","name":"Close Adresy","value":{"style":{},"triggers":[{"type":"click","selector":".adresymodal-bg","stepsA":[{"opacity":0,"transition":"opacity 500ms ease 0ms"},{"display":"none"}],"stepsB":[]}]}}
]);
